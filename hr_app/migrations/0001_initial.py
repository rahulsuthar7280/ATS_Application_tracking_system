# Generated by Django 5.2.3 on 2025-10-29 18:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('career', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hr_app.careerpage')),
            ],
        ),
        migrations.CreateModel(
            name='Application',
            fields=[
                ...
                ('job_description', models.ForeignKey(blank=True, help_text='The job description associated with this application.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='hr_app.careerpage')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resume_hash', models.CharField(blank=True, db_index=True, max_length=64, null=True)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('application', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='hr_app.apply_career')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
