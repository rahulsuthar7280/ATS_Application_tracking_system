# Generated by Django 5.2.3 on 2025-09-27 11:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon_class', models.CharField(choices=[('fa-envelope-open-text', 'Marketing'), ('fa-headset', 'Customer Service'), ('fa-user-tie', 'Human Resource'), ('fa-tasks', 'Project Management'), ('fa-chart-line', 'Business Development'), ('fa-handshake', 'Sales & Communication'), ('fa-book-open', 'Teaching & Education'), ('fa-pencil-ruler', 'Design & Creative')], default='fa-tasks', max_length=50)),
